...
var songs = {
    ...
    "ive got some falling to do": {
        ...
        "lyrics": [
            ...
            {"text": " and I stumbled", "dur": [, ]},
            {"text": "\nOut the door into the sky", "dur": [, ]},
            {"text": "\nNow I am falling through the air", "dur": [, ]},
            {"text": "\nWind and regret flow through my hair", "dur": [, ]},
            {"text": "\nAll I can do right now is stare", "dur": [, ]},
            {"text": " down at the ocean\n", "dur": [, ]},
            {"text": "\nSuddenly,", "dur": [, ]},
            {"text": " there's a ring in my cell phone.", "dur": [, ]},
            {"text": " I pick it up", "dur": [, ]},
            {"text": "\nIt's the Angel of Death,", "dur": [, ]},
            {"text": " and he says", "dur": [, ]},
            {"text": " 'Wazzup?'", "dur": [, ]},
            {"text": "\nI say,", "dur": [, ]},
            {"text": " 'What is it this time?'", "dur": [, ]},
            {"text": "\nAnd he's like,", "dur": [, ]},
            {"text": " 'Well,", "dur": [, ]},
            {"text": " hello,", "dur": [, ]},
            {"text": " goodbye,", "dur": [, ]},
            {"text": " I'll see you in hell.'", "dur": [, ]},
            {"text": "\nHe can be like that sometimes,", "dur": [, ]},
            {"text": " he's such a nut", "dur": [, ]},
