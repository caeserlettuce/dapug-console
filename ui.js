...
var songs = {
    ...
    "still alive": {
        ...
        "lyrics": [
            ...
            {"text": "This was a triumph.", "dur": [, ]},
            {"text": "\nI'm making a note here:", "dur": [, ]},
            {"text": "\nHUGE SUCCESS.", "dur": [, ]},
            {"text": "\nIt's hard to overstate", "dur": [, ]},
            {"text": "\nmy satisfaction.", "dur": [, ]},
            {"text": "\nAperture Science", "dur": [, ]},
            {"text": "\nWe do what we must", "dur": [, ]},
            {"text": "\nbecause we can.", "dur": [, ]},
            {"text": "\nFor the good of all of us", "dur": [, ]},
            {"text": "\nExcept the ones who are dead.\n\n", "dur": [, ]},
            {"text": "But there's no sense crying", "dur": [, ]},
            {"text": "\nover every mistake.", "dur": [, ]},
            {"text": "\nYou  just keep on trying", "dur": [, ]},
            {"text": "\ntill you run out of cake.", "dur": [, ]},
            {"text": "\nand the science gets done.", "dur": [, ]},
            {"text": "\nand you make a neat gun.", "dur": [, ]},
            {"text": "\nFor the people who are", "dur": [, ]},
            {"text": "\nstill alive.", "dur": [, ]},
            {"text": "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n ", "dur": [, ]},
            {"text": "\nForms FORM-55551-5:", "dur": [, ]},
            {"text": "\nPersonnel File Addendum:", "dur": [, ]},
            {"text": "\n\n ", "dur": [, ]},
            {"text": "\nDear <<Subject Name Here>>,", "dur": [, ]},
            {"text": "\n ", "dur": [, ]},
            {"text": "\nI'm not even angry.", "dur": [, ]},
            {"text": "\nI'm being so sincere right now.", "dur": [, ]},
            {"text": "\nEven though you broke my heart.", "dur": [, ]},
            {"text": "\nAnd killed me.", "dur": [, ]},
            {"text": "\nAnd tore me to pieces.", "dur": [, ]},
            {"text": "\nAnd threw every piece into a fire.", "dur": [, ]},
            {"text": "\nAs they burned it hurt because", "dur": [, ]},
            {"text": "\nI was so happy for you!", "dur": [, ]},
            {"text": "\nNow these points of data", "dur": [, ]},
            {"text": "\nmake a beautiful line.", "dur": [, ]},
            {"text": "\nAnd we're out of beta.", "dur": [, ]},
            {"text": "\nWe're releasing on time.", "dur": [, ]},
            {"text": "\nSo I'm GLaD. I got burned.", "dur": [, ]},
            {"text": "\nThink of all the things we learned", "dur": [, ]},
            {"text": "\nfor the people who are", "dur": [, ]},
            {"text": "\nstill alive.", "dur": [, ]},
            {"text": "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n ", "dur": [, ]},
            {"text": "\nForms FOEM-55551-6:", "dur": [, ]},
            {"text": "\nPersonnel File Addendum Addendum:", "dur": [, ]},
            {"text": "\n ", "dur": [, ]},
            {"text": "\nOne last thing:", "dur": [, ]},
            {"text": "\n\n", "dur": [, ]},
            {"text": "\nGo ahead and leave me.", "dur": [, ]},
            {"text": "\nI think I prefer to stay inside.", "dur": [, ]},
            {"text": "\nMaybe you'll find someone else", "dur": [, ]},
            {"text": "\nto help you.", "dur": [, ]},
            {"text": "\nMaybe Black Mesa...", "dur": [, ]},
            {"text": "\nTHAT WAS A JOKE.", "dur": [, ]},
            {"text": " FAT CHANCE.", "dur": [, ]},
            {"text": "\nAnyway, this cake is great.", "dur": [, ]},
            {"text": "\nIt's so delicious and moist.", "dur": [, ]},
            {"text": "\nLook at me still talking", "dur": [, ]},
            {"text": "\nWhen there's Science to do.", "dur": [, ]},
            {"text": "\nWhen I look out there,", "dur": [, ]},
            {"text": "\nit makes me GLaD I'm not you.", "dur": [, ]},
            {"text": "\nI've experiments to run.", "dur": [, ]},
            {"text": "\nThere is research to be done.", "dur": [, ]},
            {"text": "\nOn the people who are", "dur": [, ]},
            {"text": "\nstill alive.", "dur": [, ]},
            {"text": "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", "dur": [, ]},
            {"text": "\n PS: And Believe me I am", "dur": [, ]},
            {"text": "\nstill alive.", "dur": [, ]},
            {"text": "\nPPS: I'm doing Science and I'm", "dur": [, ]},
            {"text": "\nstill alive.", "dur": [, ]},
            {"text": "\nPPPS: I feel FANTASTIC and I'm", "dur": [, ]},
            {"text": "\nstill alive.", "dur": [, ]},
            {"text": "\n ", "dur": [, ]},
            {"text": "\nFINAL THOUGHT", "dur": [, ]},
            {"text": "\nWhile you're dying I'll be", "dur": [, ]},
            {"text": "\nstill alive.", "dur": [, ]},
            {"text": "\n ", "dur": [, ]},
            {"text": "\nFINAL THOUGHT PS:", "dur": [, ]},
            {"text": "\nAnd when you're dead I will be", "dur": [, ]},
            {"text": "\nstill alive.", "dur": [, ]},
            {"text": "\n\n\n ", "dur": [, ]},
            {"text": "\nSTILL ALIVE.", "dur": [, ]},
            {"text": "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n ", "dur": [, ]}
