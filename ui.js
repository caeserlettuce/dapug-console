...
function updateLyrics() {       // this will be called every time the song is played, so that it can do the correct height for the newlines that clear the screen and stuff
    songs = {
        ...
        "your imaginary friend": {
            ...
            "audio": "DONT_PUSH/Lemon Demon - Your Imaginary Friend.mp3",        // https://cdn.discordapp.com/attachments/960729059829096580/964403332208791572/Lemon_Demon_-_Your_Imaginary_Friend.mp3
            "volume": 1,
            "lyrics": [
                {"text": "Simple and small", "dur": [, ]},
                {"text": "\nAlmost alone", "dur": [, ]},
                {"text": "\nCurled up in a ball", "dur": [, ]},
                {"text": "\nWith a tin can phone", "dur": [, ]},
                {"text": "\nTied to a twist", "dur": [, ]},
                {"text": "\nLeading outside", "dur": [, ]},
                {"text": "\nAnd into the mist", "dur": [, ]},
                {"text": "\nWhere the shadows hide", "dur": [, ]},
                {"text": "\n\nMaybe when you're gone", "dur": [, ]},
                {"text": "\nWe'll gladly take your place", "dur": [, ]},
                {"text": "\nYou're so nicely drawn", "dur": [, ]},
                {"text": "\nWe like your face,", "dur": [, ]},
                {"text": " and", "dur": [, ]},
                {"text": "\n\nWe want to be", "dur": [, ]},
                {"text": " your imaginary friend", "dur": [, ]},
                {"text": "\nWant to be", "dur": [, ]},
                {"text": " your imaginary friend", "dur": [, ]},
                {"text": "\n\nWhen you were young", "dur": [, ]},
                {"text": "\nYou knew us well", "dur": [, ]},
                {"text": "\nThe cat had your tongue", "dur": [, ]},
                {"text": "\nSo you could not yell", "dur": [, ]},
                {"text": "\nWhen you were cross", "dur": [, ]},
                {"text": "\nAll you could do", "dur": [, ]},
                {"text": "\nWas call it a loss", "dur": [, ]},
                {"text": "\nThough this was not true", "dur": [, ]},
                {"text": "\nWe've since disappeared", "dur": [, ]},
                {"text": "\nThat is, until tonight", "dur": [, ]},
                {"text": "\nWhen you turn out the light", "dur": [, ]},
                {"text": "\nAnd everything stands still", "dur": [, ]},
                {"text": "\nThe wind's direction shifts", "dur": [, ]},
                {"text": "\nAnd makes the curtains lift", "dur": [, ]},
                {"text": "\nAnd you see us on the sill", "dur": [, ]},
                {"text": "\n\nEvery word", "dur": [, ]},
                {"text": " that you've learned", "dur": [, ]},
                {"text": "\nEvery wish", "dur": [, ]},
                {"text": " that you've burned", "dur": [, ]},
                {"text": "\nEvery single strand of hair", "dur": [, ]},
                {"text": " in your head", "dur": [, ]},
                {"text": "\nEvery book", "dur": [, ]},
                {"text": " that you've read", "dur": [, ]},
                {"text": "\nWe love you this much!", "dur": [, ]},
                {"text": "\n\nWe want to be", "dur": [, ]},
                {"text": " your imaginary friend", "dur": [, ]},
                {"text": "\nWant to be", "dur": [, ]},
                {"text": " your imaginary", "dur": [, ]},
                {"text": "\n\nFriend", "dur": [, ]}
            ]
        },
        "archaeopteryx": {
